...
/**
 * Classe responsável em tratar o serviço de Restabelecimento da Ligação de Água.
 * 
 * @author Marcos Bahiense
 * @data 01/05/2015
 * @version 1.0
 * */
public class RestabelecimentoLigacaoAgi extends BaseAgiScript{
	...
	public void service(AgiRequest request, AgiChannel channel) throws AgiException {
		...
		Resposta retorno = ws.solicitarRestabelecimento(strIdImovel, strNumeroRa);
